...
class SimpleCaptcha {
    ...
    public $fonts = array(
        ...
        'Times'    => array('spacing' => -2, 'minSize' => 18, 'maxSize' => 20, 'font' => 'TimesNewRomanBold.ttf'),
        'VeraSans' => array('spacing' => -1, 'minSize' => 18, 'maxSize' => 20, 'font' => 'VeraSansBold.ttf'),
    );

    /** Wave configuracion in X and Y axes */
    public $Yperiod    = 0;//12
    public $Yamplitude = 0;//14
    public $Xperiod    = 0;//11
    public $Xamplitude = 0;//5

    /** letter rotation clockwise */
    public $maxRotation = 1;//8
