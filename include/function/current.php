...
function current_frontend() {
	...
	//$a['/Cho-Voucher'] = 'Chợ Voucher';

	//$a['/Chia-Se'] = 'Chia sẻ';

	$a['/Tin-Khuyen-Mai'] = 'Tin khuyến mãi';

	//$a['/Bao-Ve-Tieu-Dung'] = 'Bảo vệ tiêu dùng';

	

	//$a['/dang-ky-mo-shop'] = 'Đăng ký mở shop';

	//if(option_yes('navnews')) $a['/tin-tuc'] = 'Tin '.$INI['system']['abbreviation'];

	//if(option_yes('navgsale')) $a['/cach-thuc-mua-hang'] = 'Hướng dẫn';
	...
	//elseif (preg_match('#/dang-ky-mo-shop#',$r)) $l = '/dang-ky-mo-shop';

	//elseif (preg_match('#/tin-tuc#',$r)) $l = '/tin-tuc';

	//elseif (preg_match('#/Cho-Voucher#',$r)) $l = '/Cho-Voucher';

	//elseif (preg_match('#/Bao-Ve-Tieu-Dung#',$r)) $l = '/Bao-Ve-Tieu-Dung';

	elseif (preg_match('#/Tin-Khuyen-Mai#',$r)) $l = '/Tin-Khuyen-Mai';

	//elseif (preg_match('#/Chia-Se#',$r)) $l = '/Chia-Se';
...
function current_backend() {
	...
	$a = array(
		...
		//	'/manage/location/index.php' => 'Khu vực',
			...
			'/manage/cate/index.php' => 'Danh mục',
...
function current_account2($selector) {
	...
	$a = array(
		...
		'/trang-ca-nhan' => 'Thông tin cá nhân',

		'/trang-ca-nhan/lich-su-mua-hang' => 'Lịch sử mua hàng',
	...
	if (preg_match('#/trang-ca-nhan/lich-su-mua-hang#',$r)) $l = '/trang-ca-nhan/lich-su-mua-hang';
...
function mcurrent_order($selector=null) {
	...
	//	'/manage/order/down.php' => 'Tải về',
		'/manage/order/export.php' => 'Tải đơn hàng',
...
function mcurrent_team($selector=null) {
	...
	$a = array(
		...
		'/manage/team/index.php' => 'Hiện tại',

		'/manage/team/success.php' => 'Thành công',

		'/manage/team/failure.php' => 'Thất bại',
		
		'/manage/team/expried.php' => 'Sắp hết hạn',

		'/manage/team/edit.php' => 'Thêm deal',
