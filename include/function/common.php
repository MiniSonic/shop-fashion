...
function get_name_local($id=0){
	...
	if($id==0){
		...
		$locations = Table::Fetch('location', $id);
...
function rewrite_cate_shop($cate_id){
	...
	$link = '/hot-deal/'.$cate_id.'/'.$cate_name;
...
function rewrite_news_id($news_id){
	...
	$link ="/".$cates_name."/".$create_date."/".$news['id']."/".$news_title.".html";
