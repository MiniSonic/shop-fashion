function Cart() {
    var s = function () {
        ...
        var r = 0,
            i = +$("#shipping").val(),
            t;
        $(".sum_item_value_price").html("<p>" + formatCurrency(n("0")) + "</p>"), $(".sum_item_value_trasau").html("<p>" + formatCurrency(n("1")) + "</p>"), t = n() + i, $(".sum_item_value_total").html("<p>" + formatCurrency(t) + "</p>")
    }, o = function (n) {
        $.ajax({
            type: "POST",
