...
(function (n, t) {
    ...
    SendFeedBack: function () {
        $("#btnGopY").click(function () {
			...
			if ($("#Province1").val()==0) {
                _gopy.NoticeBind("Vui lòng chọn tỉnh thành"), _gopy.ClearNotice();
                return
            }
			if ($("#District1").val()==0) {
                _gopy.NoticeBind("Vui lòng chọn quận huyện"), _gopy.ClearNotice();
                return
            }
            ...
            $.ajax({
                url: "/jquery/buynow.php",
                type: "POST",
                dataType: "html",
                data: $("#frmgopy").serialize(),
                beforeSend: function () {},
                success: function (n) {
                    n == "1" ? (window.location = "/DonHang?thanhcong", _gopy.ClearFormGopY(), _gopy.ClearNotice(), _gopy.CloseFormGopY(), CloseMark()) : (_gopy.NoticeBind("Gửi không thành công. Vui lòng thử lại."), _gopy.ChangeGopYCaptcha())
                },
                error: function () {
