...
<div id="coupons">
	<div class="dashboard" id="dashboard">
		<ul><?php echo mcurrent_order('ref'); ?></ul>
	</div>
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="order-list-id-<?php echo $one['id']; ?>">
						...
						<td><a href="/ajax/manage.php?action=orderdetail&id=<?php echo $one['id']; ?>" class="ajaxlink"><?php echo $one['order_code']; ?></a>
						<br/><b style="color:red"><?php echo getRecord('website',$one['web_id'],'name'); ?></b>
						</td>
