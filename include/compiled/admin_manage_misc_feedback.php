		...
		<div class="box clear">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr><th width="200">Khách hàng</th><th width="80">Nhóm</th><th width="360">Nội dung</th><th width="80">Trạng thái</th><th width="80">Ngày tháng</th><th width="100">Thao tác</th></tr>
					<?php if(is_array($asks)){foreach($asks AS $index=>$one) { ?>
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
						<td><?php echo htmlspecialchars($one['product']); ?><br/><?php echo htmlspecialchars($one['contact']); ?></td>
						...
						<td class="op" nowrap><a href="/manage/misc/feedback.php?action=r&id=<?php echo $one['id']; ?>&r=<?php echo $currefer; ?>" class="remove-record">Xoá</a><?php if(!$one['user_id']){?>｜<a href="/manage/misc/feedback.php?action=m&id=<?php echo $one['id']; ?>&r=<?php echo $currefer; ?>">Quyết định</a><?php }?></td>
					</tr>
					<?php }}?>
