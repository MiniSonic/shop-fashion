            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
                        ...
                        <td>
                        	<?php if($one['image_cate']){?>
                        	<img src="/static/<?php echo $one['image_cate']; ?>" width="20" height="20">
                            <?php }?>
                        </td>
					...
					<td class="op" nowrap><a href="/manage/cate/index.php?type=<?php echo $type; ?>&action=edit&id=<?php echo $one['id']; ?>">Sửa</a> | <a href="/ajax/manage.php?action=cateremove&id=<?php echo $one['id']; ?>" class="ajaxlink" ask="Bạn có chắc xoá danh mục này không?">Xoá</a></td>
