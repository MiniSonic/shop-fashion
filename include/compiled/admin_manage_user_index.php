		...
		<div class="box clear">
            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<tr><th width="20">ID</th><th width="160">Email/Tên người dùng</th><th width="130" nowrap>Địa chỉ</th><th width="120">IP/TG đăng ký</th></th><th width="100">Số điện thoại</th><th width="120">Thao tác</th></tr>
					...
					<tr <?php echo $index%2?'':'class="alt"'; ?> id="team-list-id-<?php echo $one['id']; ?>">
						...
						<td><?php echo $one['address'].', '.getRecord('vncountry',$one['ward_id'],'name').', '.getRecord('vncountry',$one['district_id'],'name').', '.getRecord('vncountry',$one['province_id'],'name'); ?></td>
