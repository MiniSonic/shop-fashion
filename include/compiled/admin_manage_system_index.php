            ...
            <div class="box-content">
                ...
                <div class="sect">
                    ...
                    <form method="post">
                        ...
                        <input type="hidden" size="30" name="system[domain_reg]" class="f-input" value="<?php echo md5($_SERVER['SERVER_NAME']); ?>"/>
                        <input type="hidden" size="30" name="system[serial_reg]" class="f-input" value="1234567890"/>
                        <input type="hidden" size="30" name="system[file_server]" class="f-input" value="http://yeugiare.com/license.txt"/>
						...
						<div class="wholetip clear"><h3>3. Cài đặt Fanpage</h3></div>
						...
						<div class="wholetip clear"><h3>4. Chăm sóc khách hàng online</h3></div>
						...
						<div class="wholetip clear"><h3>5. Thông tin khác </h3></div>
