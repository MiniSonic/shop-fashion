...
$order_code = rand_order_code('DEAL',5,3);
//use coupon
if($couponcode){
...
$insert = array(
	...
	'district_id', 'ward_id', 'web_id', 'address', 'paymoney', 'total_price', 'card', 'fare', 'remark', 'create_time','fullname',
);
...
if($flag){
	...
	redirect(WEB_ROOT."/DonHang?id={$order_id}");
}else{
	$_SESSION['cart'] = array();
	redirect(WEB_ROOT."/");
}
