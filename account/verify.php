...
if ( $user['enable'] == 'Y' ) {
	Session::Set('error', 'Tài khoản đã được xác nhận, xin vui lòng đăng nhập!');
...
if ( $user ) {
	...
	Session::Set('notice', 'Xin chúc mừng! Tài khoản của bạn đã được xác nhận thông qua email của bạn');
