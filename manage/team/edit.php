...
$summary = $CKEditor->editor("summary", $summary_content);
...
if ( is_get() && empty($team) ) {
	...
	$insert = array(
		...
		'title', 'market_price', 'team_price', 'input_price', 'end_time', 

		'begin_time', 'expire_time', 'min_number', 'max_number', 

		'summary', 'notice', 'per_number', 'product', 'slide', 'gender',
		...
		'infop1','infop2','infop3','infop4','infop5','infop6','infop7','infop8','infop9','infop10',
